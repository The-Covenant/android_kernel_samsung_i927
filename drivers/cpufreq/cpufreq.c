...
#define CPUMVMIN 770
int cpufrequency[FREQCOUNT] = { 1280000, 1200000, 1100000, 1000000, 912000, 816000, 760000, 750000, 608000, 456000, 312000, 216000 };
/*int cpuvoltage[FREQCOUNT] = { 1250, 1225, 1125, 1125, 1100, 1050, 1000, 975, 900, 825, 770, 770 }; */
int cpuvoltage[FREQCOUNT] = { 1175, 1125, 1075, 1050, 1000, 950, 925, 925, 900, 825, 770, 770 };
